...
class CodageForm(npyscreen.FormWithMenus, npyscreen.ActionFormMinimal):
    def create(self):
    ...
    def afterEditing(self):
        pass
    def on_ok(self):
        self.output.values = [CodageHelper.encode(self.Options.get("Type de codage").value[0], self.Options.get("Votre Message").value)]